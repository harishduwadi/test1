...
void Main ()
{
	...
	if ((pid = Fork ()) == 0) {
		...
		/* The above print statment printed the value 0. This is
		   because the pid will be set to 0 for the child process
		   because of the return of the fork method. 
		   */
		Exit ();
		/* When commenting out the exit method. The lines after this
		   block gets executed.*/
	}
